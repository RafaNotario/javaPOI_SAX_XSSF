...
public class XSSFReaderExample {
    public static void main(String[] args) throws Exception {
        final String FILE_NAME = "A://PRUEBAS SISTEMA/HEAT NEW/01032021/Servicios Aplicados De Cobranza Mercantil Vd Sa De Cv   Extrajudicial.xlsx";
    ...
    private static class SheetHandler extends DefaultHandler {
        ...
        public void startElement(String uri, String localName, String name, Attributes attributes) throws SAXException {
            ...
            // element c represents Cell
                ...
                System.out.print(attributes.getValue("r")+ " - ");//tenia r
               // System.out.println(sharedStringsTable.getRelationId(attributes.getValue("r")));
        ...
        public void endElement(String uri, String localName, String name) throws SAXException {
          /*  if (isCellValue && fromSST) {
                ...
                System.out.println("Ra :"+contents);
                isCellValue = false;
                fromSST = false;
            }*/
